...
class dragon:
    ...
    def __init__(self):
        self.image = load_image('ashboi.png')
...
class flames:
    ...
    def __init__(self):
        self.image = load_image('keball.png')
        self.imagerect = self.image.get_rect()
...
pygame.display.set_caption('PICKACHU')
